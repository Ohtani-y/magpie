...
# DeepSeek-R1-0528-FP4 - Math Dataset Generation Script
...
if [ -z "$1" ]; then
    ...
    echo "💡 例: $0 deepseek-ai/DeepSeek-R1-0528-FP4 1000"
    exit 1
fi
MODEL_PATH="$1"
...
echo "🧮 DeepSeek-R1-0528-FP4 - Math Dataset Generation"
echo "==============================================="
...
OUTPUT_DIR="../data/DeepSeek-R1-0528-FP4_${TIMESTAMP}"
mkdir -p "$OUTPUT_DIR"

# Note: FP4 quantization allows running larger models with less memory
echo -e "\n⚡ Using DeepSeek R1 FP4 quantized version for efficient generation"
