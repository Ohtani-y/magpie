...
# DeepSeek R1 Distill Llama 70B - Math Dataset Generation Script
...
if [ -z "$1" ]; then
    ...
    echo "💡 例: $0 deepseek-ai/DeepSeek-R1-Distill-Llama-70B 1000"
    exit 1
fi
MODEL_PATH="$1"
...
echo "🧮 DeepSeek R1 Distill Llama 70B - Math Dataset Generation"
echo "========================================================="
...
OUTPUT_DIR="../data/DeepSeek-R1-Distill-Llama-70B_${TIMESTAMP}"
mkdir -p "$OUTPUT_DIR"

# Note: 70B model requires more GPU memory
echo -e "\n⚠️  This model requires significant GPU memory (A100 80GB recommended)"
